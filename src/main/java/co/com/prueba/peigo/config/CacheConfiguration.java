...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, co.com.prueba.peigo.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, co.com.prueba.peigo.repository.UserRepository.USERS_BY_EMAIL_CACHE);
