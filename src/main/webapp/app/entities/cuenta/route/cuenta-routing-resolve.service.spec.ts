...
describe('Cuenta routing resolve service', () => {
  ...
  let resultCuenta: ICuenta | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new ICuenta if id is not provided', () => {
      // GIVEN
      ...
      expect(resultCuenta).toEqual(new Cuenta());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Cuenta })));
      mockActivatedRouteSnapshot.params = { id: 123 };
